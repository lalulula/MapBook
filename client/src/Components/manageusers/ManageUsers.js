                ...
                <div className="manage_users_top">
                    ...
                    <div className="manage_users_top_right">
                        ...
                        <div className="sort_by">
                            <Dropdown options={options} placeholder="Sort by" className="manage_users_dropdown" />
                        </div>
                    </div>
                </div>
                <div className="manage_users_middle">
                    {data.map((user, index) => (
                        <div className="manage_users_user">
                            <div className="manage_users_name">
                                {user.name}
                            </div>
                            <div className="manage_users_username">
                                {user.username}
                            </div>
