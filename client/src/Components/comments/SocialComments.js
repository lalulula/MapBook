...
import {
  createSocialCommentAPIMethod,
  deleteSocialCommentAPIMethod,
  getAllExistingSocialCommentsAPI,
...
const SocialComments = () => {
  ...
  useEffect(() => {
    getAllExistingSocialCommentsAPI().then((c) => {
            ...
            {finalComments.map((comment, i) => (
              <div className="social_comment" key={i}>
                <div className="social_comment_header">
                  <img
                    className="social_comment_profile_img"
                    src={
                ...
                {editingCommentId === comment._id ? (
                  ...
                  <div>
                    <p className="social_comment_content">
                      {comment.social_comment_content}
                    </p>
                    <div className="social_comment_replies_container">
                      <SocialReplies
                        commentId={comment._id}
          ...
          <div className="social_comments_bottom">
            {isAuth ? (
              <>
                ...
                ></textarea>
                <button
                  className="social_comment_button"
