...
import {
  createSocialReplyAPIMethod,
  deleteSocialReplyAPIMethod,
  getAllExistingSocialRepliesAPI,
  getAllSocialRepliesAPI,
  updateSocialReplyAPIMethod,
} from "../../api/comment";
                      ...
                      <img
                        ...
                        src={
                          (
                            allUsers.length > 0 &&
                            allUsers.find(
                              (u) => u._id === reply.social_reply_owner
                            )
                          ).profile_img
                        }
                      />
                        ...
                        <div>
                          ...
                          {reply.social_reply_owner === currentUserId && (
                            <div className="social_reply_dotted_menu_container">
                              ...
                              <div
                                className="social_reply_dotted_menu"
