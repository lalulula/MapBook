...
const Map = ({
  ...
  const createMap = async (mapData) => {
    ...
    const newMapObj = {
      ...
      mapPreviewImg: mapImage ? mapImage : mapImageLink,
      file: mapData,
    };
...
//             setHoverData("No data");
//           } else {
//             var template = selectedMapFile["mapbook_template"];
//             var newData = JSON.stringify(
//               tempFeature["properties"].mapbook_data
//             );
//             console.log(newData, typeof newData, template);
